...
export default function SimpleMap({ 
  ...
  if (error) {
    return (
      <div className={`w-full h-[700px] bg-muted rounded-lg flex items-center justify-center ${className}`}>
  ...
  return (
    <div className={className}>
      <div ref={mapRef} className="w-full h-[700px] rounded-lg border border-border">
        {!isLoaded && (
