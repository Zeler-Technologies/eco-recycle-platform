...
export const ScrapyardListScreen: React.FC<ScrapyardListScreenProps> = ({
  ...
  return (
    <div className="min-h-screen w-full p-4" style={{ backgroundColor: 'hsl(48 96% 53%)' }}>
      <div className="bg-white rounded-2xl p-4 mt-8 max-h-[75vh] overflow-y-auto max-w-md mx-auto">
        {/* Header */}
          ...
          <div className="fixed bottom-0 left-0 right-0 p-4 border-t" style={{ backgroundColor: 'hsl(48 96% 53%)' }}>
            <div className="flex gap-4 max-w-md mx-auto">
              ...
              <button
                ...
                className={`flex-1 py-3 rounded-full font-semibold border-2 border-black transition-colors ${
                  selectedScrapyard
