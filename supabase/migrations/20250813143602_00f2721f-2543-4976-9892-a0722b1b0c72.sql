...
-- First, drop and recreate the validate_swedish_pnr function with correct parameter name
...
-- Drop existing problematic policies on customer_requests
...
-- Drop existing problematic policies on car_metadata
