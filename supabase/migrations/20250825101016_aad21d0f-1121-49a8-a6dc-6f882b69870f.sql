-- Ensure old objects are replaced cleanly
DROP VIEW IF EXISTS public.v_pickup_status_unified;
DROP VIEW IF EXISTS public.v_pickup_orders_enriched;
DROP FUNCTION IF EXISTS public.update_pickup_status_unified(uuid, text, text, text[]);
