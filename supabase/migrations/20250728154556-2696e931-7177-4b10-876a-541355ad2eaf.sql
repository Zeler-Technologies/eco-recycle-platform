-- Create test data for RLS verification with proper identity column handling
-- First create test scrapyards
INSERT INTO public.scrapyards (id, name, address, postal_code, city, tenant_id) 
...
INSERT INTO public.user_roles (id, user_id, scrapyard_id, role) 
OVERRIDING SYSTEM VALUE VALUES
...
INSERT INTO public.tenant_bidding (id, scrapyard_id, bid_amount, start_date, end_date, is_active, region_code) 
OVERRIDING SYSTEM VALUE VALUES
