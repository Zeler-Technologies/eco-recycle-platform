-- Fix super admin access and tenant creation issues with proper UUID

-- First, create the super admin user in auth_users table with proper UUID
...
DROP POLICY IF EXISTS "allow_super_admin_bypass_customer_requests" ON customer_requests;
DROP POLICY IF EXISTS "allow_super_admin_bypass_scrapyards" ON scrapyards;
