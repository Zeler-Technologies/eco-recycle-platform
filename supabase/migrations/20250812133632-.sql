-- Helper function to avoid RLS recursion when resolving tenant for a scrapyard
...
-- Replace/ensure a non-recursive SELECT policy on user_roles for tenant_admins
