...
-- Seed global default configurations (without created_by for system defaults)
INSERT INTO public.billing_configuration (tenant_id, config_category, config_key, config_value) VALUES
    (NULL, 'general', 'currency', '{"currency": "EUR"}'),
    (NULL, 'general', 'timezone', '{"timezone": "Europe/Stockholm"}'),
    (NULL, 'general', 'locale', '{"locale": "en"}'),
    (NULL, 'general', 'billing_cycle', '{"billing_cycle": "monthly"}'),
    (NULL, 'payment', 'tax_rate', '{"tax_rate": 25}'),
    (NULL, 'payment', 'payment_terms_days', '{"payment_terms_days": 30}'),
    (NULL, 'payment', 'reminder_days', '{"reminder_days": [7, 14, 30]}'),
    (NULL, 'email', 'from_email', '{"from_email": "billing@pantabilen.se"}'),
    (NULL, 'email', 'from_name', '{"from_name": "Pantabilen Billing"}'),
    (NULL, 'email', 'template_invoice', '{"template_key": "invoice_standard"}'),
    (NULL, 'email', 'template_reminder', '{"template_key": "reminder_friendly"}'),
    (NULL, 'email', 'template_overdue', '{"template_key": "overdue_notice"}'),
    (NULL, 'shared_costs', 'categories', '{"administrative": {"percentage": 10}, "operational": {"percentage": 15}, "marketing": {"percentage": 5}}')
